...
CREATE UNIQUE INDEX `flag_category_index_10` ON `flag_category` (`name`, `status`);
...
CREATE UNIQUE INDEX `comment_file_index_14` ON `comment_file` (`comment_id`, `file_id`);
...
CREATE UNIQUE INDEX `post_file_index_17` ON `post_file` (`post_id`, `file_id`);

CREATE UNIQUE INDEX `post_tag_index_18` ON `post_tag` (`post_id`, `tag_id`);

CREATE UNIQUE INDEX `tag_index_19` ON `tag` (`name`, `status`);

CREATE INDEX `idx-tag-status` ON `tag` (`status`);

CREATE UNIQUE INDEX `post_mention_user_index_21` ON `post_mention_user` (`post_id`, `user_id`);

CREATE UNIQUE INDEX `post_like_index_22` ON `post_like` (`post_id`, `user_id`);
